...
from yolox.utils import vis, get_model_info, fuse_model
...
def make_parser():
    ...
    parser.add_argument('--path', default='./assets/dog.jpg', help='path to image or video')
    ...
    parser.add_argument('--fp16', dest='fp16', action='store_true', default=False, help='adopting mix precision evaluation')
    ...
    parser.add_argument('--trt', dest='trt', default=False, action='store_true', help='use TensorRT model for testing')
    return parser
...
class Predictor(object):
    ...
    def visual(self, output, img_info, cls_conf=0.35):
        ...
        vis_res = vis(img, bboxes, scores, cls_, cls_conf, self.cls_names)
        return vis_res
